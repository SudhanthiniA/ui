...
@Component({
  selector: 'app-departmentuserreport',
  templateUrl: './departmentuserreport.component.html',
  styleUrls: ['./departmentuserreport.component.scss']
})
export class DepartmentuserreportComponent implements OnInit {
  createObj: any = {
    fromdate: '',
    todate: ''
  };
