...
@Component({
  selector: 'app-addrolemanage',
  templateUrl: './addrolemanage.component.html',
  styleUrls: ['./addrolemanage.component.scss']
})
export class AddrolemanageComponent implements OnInit {
