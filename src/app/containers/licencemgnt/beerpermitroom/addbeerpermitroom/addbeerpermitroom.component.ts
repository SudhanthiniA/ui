...
@Component({
  selector: 'app-addbeerpermitroom',
  templateUrl: './addbeerpermitroom.component.html',
  styleUrls: ['./addbeerpermitroom.component.scss']
})
export class AddbeerpermitroomComponent implements OnInit {
