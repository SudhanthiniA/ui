...
@Component({
  selector: 'app-tankconversionreport1',
  templateUrl: './tankconversionreport1.component.html',
  styleUrls: ['./tankconversionreport1.component.scss']
})
export class Tankconversionreport1Component implements OnInit {

  distillerytankconversion1: any[] = [];
  ...
  getTankConversion1() {
    this.apiService.get('distilleryTankConversionReport2').then((responceData: any[]) => {
      ...
      this.distillerytankconversion1 = responceData;
  ...
  generateXls() {
    ...
    this.utilsSer.createXLSX( 'Distillery Tank Conversion Report1.xlsx', element );
    // const ws: XLSX.WorkSheet = XLSX.utils.table_to_sheet(element);
    // /* generate workbook and add the worksheet */
    // const wb: XLSX.WorkBook = XLSX.utils.book_new();
    // XLSX.utils.book_append_sheet(wb, ws, 'Sheet1');
    // /* save to file */
    // XLSX.writeFile(wb, 'Distillery Tank Conversion Report1.xlsx');
  }
  ...
  generatePdf() {
    ...
    body1.push([{}, { text: 'Tank Convertion Part 1', alignment: 'center'}, {}]);
    ...
    // dynamic row push
    for (const key in this.distillerytankconversion1) {
      if (this.distillerytankconversion1.hasOwnProperty(key)) {
        const ipdayKey = this.distillerytankconversion1[key];
    ...
    this.utilsSer.createPDF( 'Tank Convertion Part 1', dateData );
    // pdfMake.createPdf(dateData).download('Tank Convertion Part 1');
  }
}
