...
@Component({
  selector: 'app-distilleryoutsidestate',
  templateUrl: './distilleryoutsidestate.component.html',
  styleUrls: ['./distilleryoutsidestate.component.scss']
})
export class DistilleryoutsidestateComponent implements OnInit, OnDestroy {
