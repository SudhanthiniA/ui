...
@Component({
  selector: 'app-insideupindustry',
  templateUrl: './insideupindustry.component.html',
  styleUrls: ['./insideupindustry.component.scss']
})

export class InsideupindustryComponent implements OnInit {
