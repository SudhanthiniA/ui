...
@Component({
  selector: 'app-viewrequitionofrawmaterial',
  templateUrl: './viewrequitionofrawmaterial.component.html',
  styleUrls: ['./viewrequitionofrawmaterial.component.scss']
})
export class ViewrequitionofrawmaterialComponent implements OnInit {
