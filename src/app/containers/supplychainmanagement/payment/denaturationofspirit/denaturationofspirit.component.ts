...
@Component({
  selector: 'app-denaturationofspirit',
  templateUrl: './denaturationofspirit.component.html',
  styleUrls: ['./denaturationofspirit.component.css']
})
export class DenaturationofspiritComponent implements OnInit {
