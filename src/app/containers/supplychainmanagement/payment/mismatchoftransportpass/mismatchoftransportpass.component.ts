...
@Component({
  selector: 'app-mismatchoftransportpass',
  templateUrl: './mismatchoftransportpass.component.html',
  styleUrls: ['./mismatchoftransportpass.component.css']
})
export class MismatchoftransportpassComponent implements OnInit {
