...
import {ApiService,BreakageEntryService, WarehouseTrnsportPassGenService} from '@app/services';
import {
  AlertService,
  MasterapiService,
  PreviewService,
  WorkflowcofigService,
  CommonService, WholesaleStockinService
} from '@app/services';
...
@Component({
  selector: 'app-addwsstockinnew',
  templateUrl: './addwsstockinnew.component.html',
  styleUrls: ['./addwsstockinnew.component.scss']
})
export class AddwsstockinnewComponent implements OnInit {
