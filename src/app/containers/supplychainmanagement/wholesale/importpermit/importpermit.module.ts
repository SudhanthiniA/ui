...
@NgModule({
  declarations: [ImportpermitComponent, AddimportpermitComponent, ViewimportpermitComponent, ImportpermitsuccessComponent, EditimportpermitComponent, ListapproverComponent, PaymentComponent],
  imports: [
    CommonModule,
    SharedModule,
