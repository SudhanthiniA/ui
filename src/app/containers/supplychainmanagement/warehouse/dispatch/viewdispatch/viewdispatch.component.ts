...
export class ViewdispatchComponent implements OnInit {
  ...
  casesBottlesCalculation(data) {
    ...
    indentDatas.forEach(element => {
      ...
      totNoOfBottlesRequested = totNoOfBottlesRequested + element.noOfBottlesRequested
    ...
    this.calculatedData.totNoOfBottlesRequested = totNoOfBottlesRequested
