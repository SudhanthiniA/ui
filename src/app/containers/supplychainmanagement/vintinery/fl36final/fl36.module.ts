...
@NgModule({
  declarations: [Fl36Component, Addfl36Component, Viewfl36Component, Acknowledgementfl36Component, DraftfinallistComponent, PasscanmodComponent, PaymentComponent],
  imports: [
    CommonModule,
    SharedModule,
    Fl36RoutingModule
