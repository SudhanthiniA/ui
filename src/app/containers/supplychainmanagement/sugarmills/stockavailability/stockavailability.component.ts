...
export class StockavailabilityComponent implements OnInit, OnDestroy {
  ...
  gettankregester() {
    ...
    this.apiService.get('stockAvailability/availableStockTank').then((responceData: any) => {
  ...
  navigate(id) {
    // this.router.navigate(['/supplychainmanagement/sugarmills/tankmaintainance',id]); 
    this.router.navigate(['/supplychainmanagement/sugarmills/stockavailability/tankmaintainance',id]);
