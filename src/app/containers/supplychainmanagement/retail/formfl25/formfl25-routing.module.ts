...
const routes: Routes = [
  { path: '', component: Formfl25Component },
  ...
  { path: 'part1/edit/:id', component: Addpart1Component },
  ...
  { path: 'part2/edit/:id', component: Addpart2Component },
  ...
  { path: 'part3/edit/:id', component: Addpart3Component },
  ...
  { path: 'part4/edit/:id', component: Addpart4Component },
];
...
export class Formfl25RoutingModule { }
