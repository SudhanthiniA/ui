...
@Component({
  selector: 'app-accountpurchaser',
  templateUrl: './accountpurchaser.component.html',
  styleUrls: ['./accountpurchaser.component.css']
})
export class AccountpurchaserComponent implements OnInit {
  formData: any;
  formObj: any = {};
  pageNo = 0;
