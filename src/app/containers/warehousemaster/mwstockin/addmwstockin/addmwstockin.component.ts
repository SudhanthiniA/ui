...
@Component({
  selector: 'app-addmwstockin',
  templateUrl: './addmwstockin.component.html',
  styleUrls: ['./addmwstockin.component.scss']
})
export class AddmwstockinComponent implements OnInit {
