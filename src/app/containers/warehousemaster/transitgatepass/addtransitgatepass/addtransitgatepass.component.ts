...
@Component({
  selector: 'app-addtransitgatepass',
  templateUrl: './addtransitgatepass.component.html',
  styleUrls: ['./addtransitgatepass.component.scss']
})
export class AddtransitgatepassComponent implements OnInit {
  Transitpassobj = {
    indentNo: '',
    issueDate: '',
    routeValue: '',
