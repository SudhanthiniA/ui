...
@Component({
  selector: 'app-transitgatepass',
  templateUrl: './transitgatepass.component.html',
  styleUrls: ['./transitgatepass.component.css']
})
export class TransitgatepassComponent implements OnInit {
