...
@Component({
  selector: 'app-addedit-liquor',
  templateUrl: './addedit-liquor.component.html',
  styleUrls: ['./addedit-liquor.component.scss']
})
...
export class AddeditLiquorComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.addedithead = this.router.url.includes('add') == true ?
      'Enter Below Details to Add QR Code' : 'Enter Below Details to Edit Liquor';
  }
