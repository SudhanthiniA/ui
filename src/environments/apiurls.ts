...
export const apiUrls = {
  ...
  // updateEntity: 'entityType/updateEntityType',
  ...
  //export order //
  // exportgetAllIndentImport: 'exportorder/getAllIndentImport',
  exportgetAllIndentImport: 'exportorder/getAllexportorder',
  // exportaddIndentImport: 'exportorder/addIndentImport',
  ...
  // getdistAllTankReg: 'tankRegistration/getAllTankReg',
  // getdistAllTankReg: 'tankRegistration/getTankList',
  // addTankReg: 'tankRegistration/create',
  ...
  gettransportcancelpass: 'transportPassGeneration/getTransportPassGenByTransportNo?transportNo=',
  ...
  ProbelmReportedlistgetbyId: 'problemreported/getProblemReportedById?id=',
  ...
  getaknowlegebyId: 'helpdeskknowledge/getKnowledgeById?id=',
  ...
  filtergetgname: 'helpdeskgroup/searchgroupByName?groupName=',
  ...
  //order pickup
  getallDraftorderpickup: 'indentAcceptance/acceptedIndents',
  getSubmittedrecords: 'indentAcceptance/acceptedIndents',
  ...
  downloadDocument: 'api/document/downloadfile',
